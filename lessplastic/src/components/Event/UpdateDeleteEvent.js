                ...
                <Col md={{ span: 6, offset: 3 }}>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group controlId="formGridName">
                            ...
                            <Form.Control placeholder="Name" disabled={deleteTrue === 'delete'} defaultValue={name} onChange={(e) => {setName(e.target.value)}} required/>
                        </Form.Group>
                        <Form.Group controlId="formGridTowns">
                            <Form.Label>Towns</Form.Label>
                            <Form.Control placeholder="Town1, Town2, Town3.." disabled={deleteTrue === 'delete'} defaultValue={towns} onChange={(e) => {setTowns(e.target.value)}} required/>
                        </Form.Group>
                        <Form.Group controlId="formGridDescr">
                            <Form.Label>Description</Form.Label>
                            <Form.Control as="textarea" rows='5'  placeholder="Description" disabled={deleteTrue === 'delete'} defaultValue={description} onChange={(e) => {setDescription(e.target.value)}} required/>
                        </Form.Group>
                        <Form.Group controlId="formGridDate">
                            <Form.Label>Date</Form.Label>
                            <Form.Control type="date" placeholder="Date" disabled={deleteTrue === 'delete'} defaultValue={dateOfEvent} onChange={(e) => {setDate(e.target.value)}} required/>
                        </Form.Group>
